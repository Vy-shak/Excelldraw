...
const constants = {
    variant: {
        ...
        secondary: 'border-2 rounded-md bg-primaryGreen-100 hover:bg-primaryGreen-200 border-primaryGreen-500  text-neutral-700 font-medium',
    },
    size: {
        default: 'xl:px-4 py-2  px-2  xl:py-2 text-[12px] xl:text-sm  w-fit lg:rounded-md rounded ',
        md: 'xl:px-3 py-2   px-2  xl:py-2 text-[12px] xl:text-xs  w-fit lg:rounded-md rounded',
